...
public class BlueActivity extends AppCompatActivity implements BLESPPUtils.OnBluetoothAction, View.OnClickListener {
    // 蓝牙工具
    ...
    private class DeviceDialogCtrl {
        ...
        private void addDevice(final BluetoothDevice device, final View.OnClickListener onClickListener) {
            runOnUiThread(new Runnable() {
                ...
                @Override
                public void run() {
                    TextView devTag = new TextView(BlueActivity.this);
    ...
    private void postShowToast(final String msg, final DoSthAfterPost doSthAfterPost) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(BlueActivity.this, msg, Toast.LENGTH_SHORT).show();
